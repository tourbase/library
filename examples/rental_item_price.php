...
// Pricing data for a rental item can be queried over a set time period. Tourbase will apply minimum durations and
...
// load rental item #3
$rental_item = \Tourbase\Model\Rental\Item::load(1);
